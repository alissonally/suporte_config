...
class notice_tpl_9e17bcad2364da752912c667751249c8 extends Mustache_Template
{
...
';
        // 'admin.users' section
        $buffer .= $this->sectionFa21de47f96524f3037cbbaf2b5a3348($context, $indent, $context->findDot('admin.users'));
...
';
    ...
    private function sectionFa21de47f96524f3037cbbaf2b5a3348(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (is_object($value) && is_callable($value)) {
            $source = '
							<option value="{{user_login}}">{{display_name}}</option>
						';
