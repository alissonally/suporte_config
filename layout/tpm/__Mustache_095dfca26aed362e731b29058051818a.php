...
class __Mustache_095dfca26aed362e731b29058051818a extends Mustache_Template
{
...
';
        // 'admin.users' section
        $buffer .= $this->sectionE9478577e9aff4f07ee2fd80b5930ac6($context, $indent, $context->findDot('admin.users'));
...
';
    ...
    private function sectionE9478577e9aff4f07ee2fd80b5930ac6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
