...
class __Mustache_5a52907a10beda00721c26fe45f4467d extends Mustache_Template
{
...
';
        // 'users' section
        $buffer .= $this->section3f3978caeb34b0eba7e9f964524be97c($context, $indent, $context->find('users'));
