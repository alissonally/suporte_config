...
class __Mustache_4c588331584fc20d8d9e1c5f97c49666 extends Mustache_Template
{
...
';
        // 'admin.users' section
        $buffer .= $this->section4f99fb3d2afe95568c984575be108c76($context, $indent, $context->findDot('admin.users'));
...
';
    ...
    private function section4f99fb3d2afe95568c984575be108c76(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
