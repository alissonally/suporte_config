...
class __Mustache_c628a1726cccc946682c865921a6a03f extends Mustache_Template
{
...
';
        // 'admin.users' section
        $buffer .= $this->sectionA4c80fb3b60057a007cfe5a794eb2e13($context, $indent, $context->findDot('admin.users'));
...
';
    ...
    private function sectionA4c80fb3b60057a007cfe5a794eb2e13(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
